...
class RecipeViewsTest(RecipeTestBase):
    ...
    def test_recipe_home_template_dont_loads_recipes_not_published(self):
        """Test that unpublished recipes are not shown on the home page."""
        # need a recipe for this test
    ...
    def test_recipe_category_template_dont_loads_recipes_not_published(self):
        """Test that unpublished categories are not shown on the home page."""
        # need a recipe for this test
    ...
    def test_recipe_detail_templates_loads_the_correct_recipe_detail(self):
    ...
    def test_recipe_detail_template_dont_loads_recipe_not_published(self):
        """Test that unpublished recipes are not shown on the detail page."""
        # need a recipe for this test
        recipe = self.make_recipe(is_published=False)
